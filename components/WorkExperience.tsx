    ...
    return (
        <motion.div
            ...
            <div className='mt-20 flex flex-col relative text-center md:text-left md:flex-row justify-evenly max-w-full w-full lg:w-auto lg:mx-auto items-center overflow-x-hidden'>
                ...
                <div className='mt-12 flex space-x-5 w-full overflow-scroll snap-x snap-mandatory scrollbar scrollbar-track-neutral-900/20 scrollbar-thumb-neutral-900/80'>
